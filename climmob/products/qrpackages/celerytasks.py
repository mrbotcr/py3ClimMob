...
def createQR(path,projectid, packages):
    ...
    for package in packages:
        ...
        data = str(package["user_name"])+"-"+str(package["package_id"])+"-"+projectid+"~"+str(base64.b64encode(compressed))
        ...
        create_index_html(html,png,qr,"Package "+str(package["package_id"]),projectid,package["project_name"],str(package["project_creationdate"])[:-9])
        #PDF
        # Changed by Carlos
