...
def create_qr_packages(request,user,project,options,packages):
    ...
    registerProductInstance(user,project,'qrpackage','packages_'+project+'.pdf','application/pdf','create_packages',task.id,request)