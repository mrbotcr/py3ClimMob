...
def create_packages_excell(request,user,project, data, tech):
    ...
    registerProductInstance(user,project,'packages','packages_'+project+'.xlsx','application/vnd.openxmlformats-officedocument.spreadsheetml.sheet','create_packages',task.id,request)