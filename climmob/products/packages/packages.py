...
def create_packages_excell(request, locale,user, project, data, tech):
    ...
    task = createPackages.apply_async((locale, path, project, data, tech), queue="ClimMob")
