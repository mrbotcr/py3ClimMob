...
if (!require("qvcalc"))
{
        install.packages("qvcalc",repos="http://cran.rstudio.com/")
}
if (!require("psychotools"))
{
        install.packages("psychotools",repos="http://cran.rstudio.com/")
}
if (!require("PlackettLuce"))
{
        install.packages("PlackettLuce",repos="http://cran.rstudio.com/")
}
