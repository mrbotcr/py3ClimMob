...
class TestProjectTechnologiesView(ViewBaseTest):
    ...
    def setUp(self):
        ...
        self.mock_search_technologies_in_project = (
            self.technologies_in_project_patcher.start()
        )
        ...
        self.mock_list_combinations_patcher.return_value = MagicMock(
            dict, name="list_combinations"
        )
        ...
        self.mock_technologies_user.return_value = MagicMock(
            dict, name="technologies_user"
        )
        self.mock_project_numcom.return_value = MagicMock(dict, name="project_numcom")
        self.mock_post_data.return_value = {
            "tech_id": MagicMock(name="tech_id"),
    ...
    def test_project_technologies_view_get_complete_w_error(self):
        ...
        self.assertEqual(
            result,
            {
                ...
                "techSee": {},
                "error_summary2": {
                    "totalOfCombinations": "ClimMob has limited the number of possible combinations to 50, at the moment you are exceeding this number so you must remove technology options to be able to create the packages later."
                },
    ...
    def test_project_technologies_view_post_btn_save_tech(
        self, mock_delete_technology_project
    ):
        self.mock_post_data.return_value.update(
            {
                "btn_save_technologies": True,
    ...
    def test_project_technologies_view_post_btn_sh_tech_alias(self):
        ...
        self.mock_tech_see.assert_called_once_with(
            {
                "tech_id": self.mock_post_data.return_value["tech_id"],
                "txt_technologies_included": self.mock_post_data.return_value[
                    "txt_technologies_included"
                ],
                "txt_technologies_excluded": "",
                "btn_show_technology_alias": True,
    ...
    def test_project_technologies_view_post_btn_sh_tech_alias_in_lib(
        self, mock_alias_search_technology
    ):
        self.mock_post_data.return_value.update(
            {
                "btn_show_technology_alias_in_library": True,
            }
        )
        ...
        mock_alias_search_technology.assert_called_once_with(
            self.mock_post_data.return_value["tech_id"], 1, self.view.request
        )
    ...
    def test_project_technologies_view_post_btn_add_alias(
        self, mock_prj_tech_alias_add
    ):
