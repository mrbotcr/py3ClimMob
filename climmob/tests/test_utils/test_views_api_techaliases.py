...
class TestCreateAliasView(unittest.TestCase):
    ...
    @patch('climmob.views.Api.techaliases.findTechalias', return_value=False)
    @patch('climmob.views.Api.techaliases.getTechnologyByUser', return_value=True)
    def test_process_view_create_add_true(self, mock_getTechnologyByUser, mock_findTechalias, mock_addTechAlias):
        self.view.body = json.dumps(
            {
                "tech_id": "123",
                "alias_name": "test_user",
...
class TestReadAliasView(unittest.TestCase):
    ...
    @patch('climmob.views.Api.techaliases.getTechsAlias',return_value=(
            [
                {
                    "tech_id": 0,
                    "alias_id": 0,
    ...
    @patch('climmob.views.Api.techaliases.getTechnologyByUser')
    def test_process_view_no_read_technology_by_user_bioversity(self, mock_getTechnologyByUser, mock_getTechsAlias):
        dummy_response = [{
            "tech_id": 0,
            "alias_id": 0,
            "alias_name": "",
    ...
    @patch('climmob.views.Api.techaliases.getTechnologyByUser', return_value=True)
    def test_process_view_no_read_technology_by_user_(self, mock_getTechnologyByUser, mock_getTechsAlias):
        dummy_response = [{
            "tech_id": 0,
            "alias_id": 0,
            "alias_name": "",
...
class TestUpdateAliasView(unittest.TestCase):
    ...
    @patch('climmob.views.Api.techaliases.getTechnologyByUser', return_value=(True))
    def test_process_view_no_update_no_alias(self, mock_getTechnologyByUser, mock_existAlias):
        self.view.body = json.dumps(
            {
                "tech_id": "123",
                "alias_id": "12",
        ...
        response = self.view.processView()
        self.assertEqual(response.status_code, 401)
        self.assertEqual(response.body, b"You do not have a technology option with this ID.")

    @patch('climmob.views.Api.techaliases.findTechalias', return_value=True)
    @patch('climmob.views.Api.techaliases.existAlias', return_value=(True))
    @patch('climmob.views.Api.techaliases.getTechnologyByUser', return_value=(True))
    def test_process_view_no_update_no_found_alias(self, mock_getTechnologyByUser, mock_existAlias, mock_findTechalias):
        self.view.body = json.dumps(
            {
                "tech_id": "123",
                "alias_id": "12",
        ...
        response = self.view.processView()
        self.assertEqual(response.status_code, 401)
        self.assertEqual(response.body, b"This technology option already exists for the technology.")



    @patch('climmob.views.Api.techaliases.getAliasAssignedWithoutProjectCode', return_value=True)
    @patch('climmob.views.Api.techaliases.findTechalias', return_value=False)
    @patch('climmob.views.Api.techaliases.existAlias', return_value=(True))
    @patch('climmob.views.Api.techaliases.getTechnologyByUser', return_value=(True))
    def test_process_view_no_update_project_assigned(self, mock_getTechnologyByUser, mock_existAlias, mock_findTechalias, mock_getAliasAssignedWithoutProjectCode):
        self.view.body = json.dumps(
            {
                "tech_id": "123",
                "alias_id": "12",
        ...
        response = self.view.processView()
        self.assertEqual(response.status_code, 401)
        self.assertEqual(response.body, b"You can not update this technology option because it has been assigned to a project.")
    ...
    @patch('climmob.views.Api.techaliases.updateAlias', return_value=(False,"Error at update."))
    @patch('climmob.views.Api.techaliases.getAliasAssignedWithoutProjectCode', return_value=False)
    @patch('climmob.views.Api.techaliases.findTechalias', return_value=False)
    @patch('climmob.views.Api.techaliases.existAlias', return_value=(True))
    @patch('climmob.views.Api.techaliases.getTechnologyByUser', return_value=(True))
    def test_process_view_no_update_proyect_asigned(self, mock_getTechnologyByUser, mock_existAlias, mock_findTechalias, mock_getAliasAssignedWithoutProjectCode, mock_updateAlias):
        self.view.body = json.dumps(
            {
                "tech_id": "123",
                "alias_id": "12",
    ...
    @patch('climmob.views.Api.techaliases.existAlias', return_value=(True))
    @patch('climmob.views.Api.techaliases.getTechnologyByUser', return_value=(True))
    def test_process_view_update_true(self, mock_getTechnologyByUser, mock_existAlias, mock_findTechalias, mock_getAliasAssignedWithoutProjectCode, mock_updateAlias):
        body_dict = {
            "tech_id": "123",
            "alias_id": "12",
            "alias_name": "fake_name"
        ...
        self.assertEqual(response.body, b"The technology option was updated successfully.")
...
class TestDeleteAliasViewAPI(unittest.TestCase):
    ...
    @patch('climmob.views.Api.techaliases.existAlias', return_value=(False))
    @patch('climmob.views.Api.techaliases.getTechnologyByUser', return_value=(True))
    def test_process_view_no_delete_no_alias_by_user(self, mock_getTechnologyByUser, mock_existAlias):
        self.view.body = json.dumps(
            {
                "tech_id": "123",
                "alias_id": "12",
    ...
    @patch('climmob.views.Api.techaliases.existAlias', return_value=(True))
    @patch('climmob.views.Api.techaliases.getTechnologyByUser', return_value=(True))
    def test_process_view_no_delete_proyect_assigned(self, mock_getTechnologyByUser, mock_existAlias, mock_getAliasAssignedWithoutProjectCode):
        self.view.body = json.dumps(
            {
                "tech_id": "123",
                "alias_id": "12",
        ...
        response = self.view.processView()
        self.assertEqual(response.status_code, 401)
        self.assertEqual(response.body, b"You cannot delete this technology option because it has been assigned to a project.")

    @patch('climmob.views.Api.techaliases.removeAlias',return_value=(False,"Error to delete."))
    @patch('climmob.views.Api.techaliases.getAliasAssignedWithoutProjectCode', return_value=(False))
    @patch('climmob.views.Api.techaliases.existAlias', return_value=(True))
    @patch('climmob.views.Api.techaliases.getTechnologyByUser', return_value=(True))
    ...
    def test_process_view_no_delete_no_proyect_assigned(self, mock_getTechnologyByUser, mock_existAlias,
        ...
        self.assertEqual(response.body,
                         b"The technology option was deleted successfully.")
