...
class TestCleanErrorLogsView(unittest.TestCase):
    ...
    @patch("climmob.views.cleanErrorLogs.projectExists")
    def test_process_view_get_project_id(
        self, mock_projectExists, mock_getTheProjectIdForOwner
    ):
    ...
    def test_process_view_get_project_id(
        ...
        mock_isAssessmentOpen.assert_called_once_with(
            "12345", "code123", self.mock_request
        )
    ...
    def test_process_view_is_assessment_open_false(
        ...
        mock_projectExists.assert_called_once_with(
            "test_user_login", "Test User", "Test Project", self.mock_request
        )
        mock_getTheProjectIdForOwner.assert_called_once_with(
            "Test User", "Test Project", self.mock_request
        )
    ...
    @patch(
        "climmob.views.cleanErrorLogs.get_registry_log_by_log",
        return_value=(True, "mock_log_path"),
    )
    ...
    @patch("climmob.views.cleanErrorLogs.getTheProjectIdForOwner")
    @patch("climmob.views.cleanErrorLogs.projectExists")
    def test_process_view_log_exists(
        self,
        mock_projectExists,
        mock_getTheProjectIdForOwner,
        mock_getProjectData,
        ...
        mock_get_registry_log_by_log.assert_called_once_with(
            self.mock_request, "12345", "log123"
        )
    ...
    @patch("climmob.views.cleanErrorLogs.getTheProjectIdForOwner")
    @patch("climmob.views.cleanErrorLogs.projectExists")
    def test_process_view_log_not_exists(
        self,
        mock_projectExists,
        mock_getTheProjectIdForOwner,
        mock_getProjectData,
