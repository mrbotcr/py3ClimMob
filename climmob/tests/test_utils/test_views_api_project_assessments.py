...
class TestReadProjectAssessmentsView(BaseViewTestCase):
    ...
    def test_process_view_success(self, mock_project_exists, mock_get_the_project_id_for_owner,
...
class TestAddNewAssessmentView(BaseViewTestCase):
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.projectExists', return_value=True)
    def test_process_view_no_access(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_get_access_type_for_project):
        response = self.view.processView()
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.getAccessTypeForProject', return_value=1)
    def test_process_view_invalid_body(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_get_access_type_for_project, mock_json_loads):
        self.view.body = ""
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.getAccessTypeForProject', return_value=1)
    def test_process_view_not_all_parameters(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_get_access_type_for_project):
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.getAccessTypeForProject', return_value=1)
    def test_process_view_ass_days_not_number(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_get_access_type_for_project):
        self.view.body = json.dumps({
            "project_cod": "123",
            "user_owner": "owner",
            "ass_desc": "Description",
...
class TestUpdateProjectAssessmentView(BaseViewTestCase):
    ...
    def test_process_view_success(
        ...
        mock_modify_project_assessment.assert_called_with({'project_cod': '123', 'user_owner': 'owner', 'ass_cod': 'ass123', 'ass_desc': 'Description', 'ass_days': '10', 'user_name': 'test_user', 'project_id': 1}, self.view.request)
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.projectExists', return_value=True)
    def test_process_view_assessment_not_exist(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_get_access_type_for_project, mock_assessment_exists):
        response = self.view.processView()
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.getAccessTypeForProject', return_value=1)
    def test_process_view_invalid_body(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_get_access_type_for_project):
        self.view.body = ""
...
class TestDeleteProjectAssessmentView(BaseViewTestCase):
    ...
    def test_process_view_success(
        ...
        mock_delete_project_assessment.assert_called_with('owner', 1, '123', 'ass123', self.view.request)
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.projectExists', return_value=True)
    def test_process_view_assessment_cannot_be_deleted(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_get_access_type_for_project, mock_assessment_exists, mock_project_asessment_status):
        response = self.view.processView()
...
class TestReadProjectAssessmentStructureView(BaseViewTestCase):
    ...
    def test_process_view_success(
        ...
        mock_get_assessment_questions.assert_called_with('owner', 1, 'ass123', self.view.request, ['Label A', 'Label B', 'Label C'], onlyShowTheBasicQuestions=True)
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.projectExists', return_value=True)
    def test_process_view_assessment_not_exist(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_assessment_exists):
        response = self.view.processView()
    ...
    def test_process_view_invalid_body(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_get_project_data):
        self.view.body = ""
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.assessmentExists', return_value=True)
    def test_process_view_not_all_parameters(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_assessment_exists):
        self.view.body = json.dumps({
            "project_cod": "123",
            "user_owner": "owner",
            "ass_cod": ""
...
class TestCreateAssessmentGroupView(BaseViewTestCase):
    ...
    def test_process_view_success(
        ...
        mock_have_the_basic_structure_assessment.assert_called_with('owner', 1, '456', self.view.request)
...
class TestUpdateAssessmentGroupView(BaseViewTestCase):
    ...
    @patch('climmob.views.Api.projectAssessments.projectExists', return_value=True)
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    def test_process_view_invalid_body(self, mock_project_exists, mock_get_the_project_id_for_owner):
        self.view.body = ""
...
class TestDeleteAssessmentGroupView(BaseViewTestCase):
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.projectExists', return_value=True)
    def test_process_view_group_not_exist(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_assessment_exists, mock_project_asessment_status, mock_exits_assessment_group):
        response = self.view.processView()
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.projectExists', return_value=True)
    def test_process_view_group_cannot_be_deleted(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_get_access_type_for_project, mock_assessment_exists, mock_project_asessment_status, mock_exits_assessment_group, mock_canDeleteTheAssessmentGroup):
        response = self.view.processView()
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.projectExists', return_value=True)
    def test_process_view_deletion_failed(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_get_access_type_for_project, mock_assessment_exists, mock_project_asessment_status, mock_exits_assessment_group, mock_canDeleteTheAssessmentGroup, mock_deleteAssessmentGroup):
        response = self.view.processView()
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.projectExists', return_value=True)
    def test_process_view_not_all_parameters(self, mock_project_exists, mock_get_the_project_id_for_owner,
                                             mock_assessment_exists):
        self.view.body = json.dumps({
            "project_cod": "123",
            "user_owner": "owner",
...
class TestAddQuestionToGroupAssessmentView(BaseViewTestCase):
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.projectExists', return_value=True)
    def test_process_view_user_not_belong_to_project(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_the_user_belongs_to_the_project):
        response = self.view.processView()
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.projectExists', return_value=True)
    def test_process_view_assessment_already_started(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_assessment_exists, mock_project_asessment_status):
        response = self.view.processView()
...
class TestDeleteQuestionFromGroupAssessmentView(BaseViewTestCase):
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.projectExists', return_value=True)
    def test_process_view_question_not_exist(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_get_access_type_for_project, mock_assessment_exists, mock_project_asessment_status, mock_exits_assessment_group, mock_get_question_data):
        response = self.view.processView()
    ...
    @patch('climmob.views.Api.projectAssessments.getTheProjectIdForOwner', return_value=1)
    @patch('climmob.views.Api.projectAssessments.projectExists', return_value=True)
    def test_process_view_question_required(self, mock_project_exists, mock_get_the_project_id_for_owner, mock_get_access_type_for_project, mock_assessment_exists, mock_project_asessment_status, mock_exits_assessment_group, mock_get_question_data):
        response = self.view.processView()
