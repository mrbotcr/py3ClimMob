...
__all__ = [
    'addTemplatesDirectory','addStaticView',
    'addJSResource','addCSSResource','addLibrary',
    'addRoute','getJSResource','getCSSResource',
    'climmobPublicView','climmobPrivateView',
    'addFieldToUserSchema','addFieldToProjectSchema',
    'addFieldToQuestionSchema','createUserDirecty',
    'createProjectDirecty','addProduct','addMetadataToProduct',
    'addOutputToProduct','registerProductInstance','climmobCeleryTask',
    'registerCeleryTask'
]
...
def addJSResource(libraryName,resourceID,resourceFile,depends,bottomSafe=False):
    return {'libraryname':libraryName,'id':resourceID,'file':resourceFile,'depends':depends,'bottomsafe':bottomSafe}
