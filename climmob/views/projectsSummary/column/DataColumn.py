...
DATA_COLUMNS = [
    ...
    {"key": "project_date", "name": "Date", "type": "static", "options": None, "id": 8, "show": True},
    {"key": "project_country", "name": "Country", "type": "static", "options": None, "id": 9, "show": True},
    {"key": "project_location", "name": "Location", "type": "static", "options": None, "id": 10, "show": True},
    {"key": "farmers_target", "name": "Number of farmers target", "type": "static", "options": None, "id": 11, "show": True},
    {"key": "farmers_registered", "name": "Number of registered for the project", "type": "static", "options": None, "id": 12, "show": True},
    {"key": "gender_man", "name": "Gender - Men", "type": "static", "options": None, "id": 13, "show": True},
    {"key": "gender_woman", "name": "Gender - Women", "type": "static", "options": None, "id": 14, "show": True},
    {"key": "gender_other", "name": "Gender - Other", "type": "static", "options": None, "id": 15, "show": True},
    {"key": "gender_unreported", "name": "Gender - Unreported", "type": "static", "options": None, "id": 16, "show": True},
    {"key": "crop", "name": "Crop", "type": "static", "options": None, "id": 17, "show": True},
...
def get_key_project_summary(request):
    keys=[]
