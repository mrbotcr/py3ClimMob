# coding: utf-8
from sqlalchemy import Column, DateTime, ForeignKey, ForeignKeyConstraint, Index, Integer, LargeBinary, Numeric, String, Text, text
...
class AssDetail(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['section_user', 'section_project', 'section_assessment', 'section_id'], [u'asssection.user_name', u'asssection.project_cod', u'asssection.ass_cod', u'asssection.section_id'], ondelete=u'CASCADE'),
        ForeignKeyConstraint(['user_name', 'project_cod', 'ass_cod'], [u'assessment.user_name', u'assessment.project_cod', u'assessment.ass_cod'], ondelete=u'CASCADE'),
...
class PrjEnumerator(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['user_name', 'project_cod'], [u'project.user_name', u'project.project_cod'], ondelete=u'CASCADE'),
        ForeignKeyConstraint(['enum_user', 'enum_id'], [u'enumerator.user_name', u'enumerator.enum_id'],ondelete=u'CASCADE'),
        {'mysql_engine': 'InnoDB','mysql_charset': 'utf8'}
    )
...
class Products(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['user_name', 'project_cod'], [u'project.user_name', u'project.project_cod'],
                             ondelete=u'CASCADE'),
        {'mysql_engine': 'InnoDB', 'mysql_charset': 'utf8'}
    )
...
class I18nAsssection(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['user_name', 'project_cod', 'ass_cod', 'section_id'], [u'asssection.user_name', u'asssection.project_cod', u'asssection.ass_cod', u'asssection.section_id']),
        {'mysql_engine': 'InnoDB', 'mysql_charset': 'utf8'}
    )
    ...
    ass_cod = Column(String(80), primary_key=True, nullable=False)
    section_id = Column(Integer, primary_key=True, nullable=False)
    lang_code = Column(ForeignKey(u'i18n.lang_code'), primary_key=True, nullable=False, index=True)
    section_name = Column(String(120))
    section_content = Column(Text)
...
class I18nPrjalia(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['user_name', 'project_cod', 'tech_id', 'alias_id'], [u'prjalias.user_name', u'prjalias.project_cod', u'prjalias.tech_id', u'prjalias.alias_id']),
    )
...
class I18nQstoption(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['question_id', 'value_code'], [u'qstoption.question_id', u'qstoption.value_code']),
        {'mysql_engine': 'InnoDB', 'mysql_charset': 'utf8'}
    )
...
class I18nQuestion(Base):
    ...
    question_id = Column(ForeignKey(u'question.question_id'), primary_key=True, nullable=False)
    lang_code = Column(ForeignKey(u'i18n.lang_code'), primary_key=True, nullable=False, index=True)
...
class I18nRegsection(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['user_name', 'project_cod', 'section_id'], [u'regsection.user_name', u'regsection.project_cod', u'regsection.section_id']),
    )
...
class I18nTechalia(Base):
    ...
    __table_args__ = (
        ForeignKeyConstraint(['tech_id', 'alias_id'], [u'techalias.tech_id', u'techalias.alias_id']),
    )
...
class I18nTechnology(Base):
    ...
    tech_id = Column(ForeignKey(u'technology.tech_id'), primary_key=True, nullable=False)
    lang_code = Column(ForeignKey(u'i18n.lang_code'), primary_key=True, nullable=False, index=True)
...
class Question(Base):
    ...
    __table_args__ = (
       ForeignKeyConstraint(['qstgroups_user', 'qstgroups_id'], [u'qstgroups.user_name', u'qstgroups.qstgroups_id'],ondelete=u'CASCADE'),
       {'mysql_engine': 'InnoDB', 'mysql_charset': 'utf8'}
    )
