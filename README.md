...
The current stable release is 3.9.5 and it is available [here](https://github.com/mrbotcr/py3ClimMob/tree/stable-3.9.5)

The database signature for stable 3.9.5 is 0e207d9b2dab

The latest Docker image is 3.9.5
...
cd /opt
sudo mkdir climmob_docker_compose_20260619
cd climmob_docker_compose_20260619
sudo wget https://raw.githubusercontent.com/mrbotcr/py3ClimMob/stable-3.9.5/docker_compose/docker-compose.yml
...
cd /opt/climmob_docker_compose_20260619
sudo docker-compose pull

# Edit the docker-compose.yml file to set the MySQL root password
sudo nano /opt/climmob_docker_compose_20260619/docker-compose.yml
