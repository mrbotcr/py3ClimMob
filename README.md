...
The current stable release is 3.3.0 and it is available [here](https://github.com/BioversityCostaRica/py3ClimMob/tree/stable-3.3.0)

The database signature for stable 3.3.0 is 1b05b458a49d

The Docker image for stable 3.3.0 is 20210503
...
cd /opt
sudo mkdir climmob_docker_compose_20210503
cd climmob_docker_compose_20210503
sudo wget https://raw.githubusercontent.com/BioversityCostaRica/py3ClimMob/stable-3.3.0/docker_compose/docker-compose.yml
...
cd /opt/climmob_docker_compose_20210503
sudo docker-compose pull

# Edit the docker-compose.yml file to set the MySQL root password
sudo nano /opt/climmob_docker_compose_20210503/docker-compose.yml
