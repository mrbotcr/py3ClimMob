...
The current stable release is 3.9.4 and it is available [here](https://github.com/mrbotcr/py3ClimMob/tree/stable-3.9.4)

The database signature for stable 3.9.4 is ac96c89a6cf7

The latest Docker image is 3.9.4
...
cd /opt
sudo mkdir climmob_docker_compose_20260515
cd climmob_docker_compose_20260515
sudo wget https://raw.githubusercontent.com/mrbotcr/py3ClimMob/stable-3.9.4/docker_compose/docker-compose.yml
...
cd /opt/climmob_docker_compose_20260515
sudo docker-compose pull

# Edit the docker-compose.yml file to set the MySQL root password
sudo nano /opt/climmob_docker_compose_20260515/docker-compose.yml
