...
The current stable release is 3.8.1 and it is available [here](https://github.com/BioversityCostaRica/py3ClimMob/tree/stable-3.8.0)

The database signature for stable 3.8.1 is 55702fd698f4

The Docker image for stable 3.8.1 is 20230401
...
cd /opt
sudo mkdir climmob_docker_compose_20230401
cd climmob_docker_compose_20230401
...
cd /opt/climmob_docker_compose_20230401
sudo docker-compose pull

# Edit the docker-compose.yml file to set the MySQL root password
sudo nano /opt/climmob_docker_compose_20230401/docker-compose.yml
