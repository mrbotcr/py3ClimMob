...
cd /opt
sudo mkdir climmob_docker_compose_20250718
cd climmob_docker_compose_20250718
...
cd /opt/climmob_docker_compose_20250718
sudo docker-compose pull

# Edit the docker-compose.yml file to set the MySQL root password
sudo nano /opt/climmob_docker_compose_20250718/docker-compose.yml
